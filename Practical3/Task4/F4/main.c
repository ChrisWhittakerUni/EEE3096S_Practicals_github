...
int height;
int width;
int width_values[20] = {100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 1920};
int height_values[20] = {100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 850, 900, 950, 1000, 1080};
int imag_dim;
uint64_t checksum;
int imag_dim_arr[20];
uint64_t time_elapsed_arr[20];
uint64_t checksum_arr[20];
uint64_t start_time;
uint64_t end_time;
  ...
  // loop to make testing easier
   for(int i=0; i<20; i++){
      ...
      //}
 		 ...
 		 imag_dim_arr[place] = height*width;
