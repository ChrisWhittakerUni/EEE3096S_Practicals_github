...
/*
//TODO: Mandelbroat using variable type integers and fixed point arithmetic using scale factor of 10^6
uint64_t calculate_mandelbrot_fixed_point_arithmetic(int width, int height, int max_iterations){
  ...
  int64_t iteration;
  int64_t temp;
  int64_t h_adj = 2000000/height;
  int64_t w_adj = 3500000/width;
...
/*
//TODO: Mandelbroat using variable type integers and fixed point arithmetic using scale factor of 10^4
uint64_t calculate_mandelbrot_fixed_point_arithmetic(int width, int height, int max_iterations){
  uint64_t mandelbrot_sum = 0;
  //TODO: Complete the function implementation
  int64_t x_0;
  ...
  int64_t iteration;
  int64_t temp;
  int64_t h_adj = 20000/height;
  int64_t w_adj = 35000/width;
  for(int y=0; y<height; y++){
	  for(int x=0; x<width; x++){
		  x_0 = (x*w_adj) - (25000);
		  y_0 = (y*h_adj) - (10000);
		  ...
		  while((iteration < max_iterations) && (((x_i*x_i+y_i*y_i)/10000) <= 40000)){
			  temp = ((x_i*x_i)/10000)-((y_i*y_i)/10000) + (x_0);
			  y_i = ((2*x_i*y_i)/10000) + y_0;
			  x_i = temp;
			  iteration += 1;
		  }
		  mandelbrot_sum += iteration;
...
//TODO: Mandelbroat using variable type integers and fixed point arithmetic using 10^3 scale factor
uint64_t calculate_mandelbrot_fixed_point_arithmetic(int width, int height, int max_iterations){
  uint64_t mandelbrot_sum = 0;
  //TODO: Complete the function implementation
  int64_t x_0;
  ...
  int64_t iteration;
  int64_t temp;
  int64_t h_adj = 2000/height;
  int64_t w_adj = 3500/width;
  for(int y=0; y<height; y++){
	  for(int x=0; x<width; x++){
		  x_0 = (x*w_adj) - (2500);
		  y_0 = (y*h_adj) - (1000);
		  ...
		  while((iteration < max_iterations) && (((x_i*x_i+y_i*y_i)/1000) <= 4000)){
			  temp = ((x_i*x_i)/1000)-((y_i*y_i)/1000) + (x_0);
			  y_i = ((2*x_i*y_i)/1000) + y_0;
			  x_i = temp;
			  iteration += 1;
		  }
		  mandelbrot_sum += iteration;
